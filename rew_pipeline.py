...
../DRC-doc/REW-INVERSION.md (steps 2-10), then check the result with
../DRC-doc/drc_acceptance.py. Full writeup: REW-INVERSION.md, "Part V --
...
IMPLEMENTATION-STATUS.md -- and every one of them is a flag, so a rebuild at
...
def parse_args():
    ...
    p.add_argument('--acceptance', type=Path, default=Path('../DRC-doc/drc_acceptance.py'))
